								...
								<ul class="nofitications-dropdown">
									<li class="dropdown head-dpdn">
										...
										<ul class="dropdown-menu">
											...
											<li><a href="#">
											   <div class="user_img"><img src="/resources/core/images/p4.png" alt=""></div>
               ...
               <div class="mail-toolbar clearfix" style="width:150%">
				     <div class="float-left">
				        <div class="btn btn_1 btn-default mrg5R">
				           ...
				           <a class="btn btn-primary" href="agregar_paquete_admin.jsp">
                                ...
                                <table class="table table-hover">
                                	...
                                	<tbody>
                                		<tr>
                                			...
                                			<td>
                                				<a class="btn btn-warning" href="editar_paquete_admin.html" aria-label="Delete">
