...
<div class="chit-chat-layer1">
	<div class="col-md-12 chit-chat-layer1-left">
               <div id="frame" class="work-progres">
               	            <div id="head">
	                           <div id="title" class="chit-chat-heading">
                                  Lista de Usuarios  	
                              <p> &nbsp </p>			  
                            </div>	                            
    ...
    <div class="sidebar-menu">
		    ...
		    <div class="menu">
		      <ul id="menu" >
                ...
                <ul>
		            <li><a href="usuarios_admin.html">Usuarios</a></li>
		            <li><a href="agencias_admin.html">Agencias Tur&iacute;sticas</a></li>	
                    <li><a href="paquetes_admin.html">Paquetes Tur&iacute;sticas</a></li>	
                    <li><a href="restaurar_admin.html">Restaurar Informaci&oacute;n</a></li>            
		          </ul>
		        </li>
		          <li><a href="reportes_admin"><i class="fa fa-book nav_icon"></i><span>Reportes</span></a></li>
